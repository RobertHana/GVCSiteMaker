...
public class ConfirmUnitCreationPage extends WOComponent implements SMSecurePage
{

    protected NSArray _unitArray, _validUnitArray, _invalidUnitArray;


    public ConfirmUnitCreationPage(WOContext aContext)
    {
        super(aContext);
    }
    ...
    public WOComponent cancel() {
        return pageWithName("CreateUnitPage");
    }

    public WOComponent create() {
        OrgUnit.createOrgUnitsFromArrayOfOrgUnitDictionaries( validUnitArray(),
                                                              session().defaultEditingContext() );
        UnitCreationReportPage nextPage = (UnitCreationReportPage)pageWithName("UnitCreationReportPage");
        nextPage.setUnitArray(getUnitArray());
