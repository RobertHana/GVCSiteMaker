 ...
 */
public class DataAccessSingleRecordEditor extends DataAccessSubEditor
{
     ...
     */
    public DataAccessSingleRecordEditor(WOContext context)
    {
        super(context);
    }
    ...
    {
        return com.gvcsitemaker.core.pagecomponent.DataAccessMode.SINGLE_MODE;
    }
