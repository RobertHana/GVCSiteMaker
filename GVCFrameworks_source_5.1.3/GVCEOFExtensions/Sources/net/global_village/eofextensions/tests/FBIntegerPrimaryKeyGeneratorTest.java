 ...
 */
public class FBIntegerPrimaryKeyGeneratorTest extends GVCJUnitEOTestCase
{
    ...
    public FBIntegerPrimaryKeyGeneratorTest(String name)
    {
        super(name);
    }
    ...
    public void setUp() throws java.lang.Exception
    {
        ...
        FBIntegerPrimaryKeyGenerator pkGenerator = new FBIntegerPrimaryKeyGenerator(PKCacheSize);
