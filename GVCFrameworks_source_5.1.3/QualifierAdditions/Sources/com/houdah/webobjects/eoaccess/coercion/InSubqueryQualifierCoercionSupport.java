 ...
 */
public class InSubqueryQualifierCoercionSupport implements QualifierAttributeCoercion.Support
{
	/**
	...
	public EOQualifier coerceQualifierAttributes(EOQualifier qualifier, EOEntity entity)
	{
		...
		NSDictionary substitutions = new NSDictionary(QualifierAttributeCoercion
				.coerceQualifierAttributes(subQualifier, entity), InSubqueryQualifier.SUB_QUALIFIER);

		return isQualifier.clone(substitutions);
	}
}