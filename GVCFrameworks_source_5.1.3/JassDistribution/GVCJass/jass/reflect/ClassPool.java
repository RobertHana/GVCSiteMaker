...
public final class ClassPool
{
    ...
    private static String[][] PRIMITIVE_TYPES = { { "boolean", "Z" }, {
            "byte", "B" }, {
            "char", "C" }, {
            "short", "S" }, {
            "int", "I" }, {
    ...
    public static Class getClass(String classname)
    {
            ...
            else
            {
                    ...
                    || NameAnalysis.lookUpInClassPath(component))
                {
                    ...
                    else
                    {
                        ...
                        {
                            System.out.println(
                                "Message: Adding class " + classname + ".");
                        }
                ...
                ReflectionError e =
                    new ReflectionError(
                        "Fatal Error: Could not find class '"
                            + classname
        ...
        throw new ReflectionError(
            "Fatal Error: Could not find class " + classname + ".");
    }
    ...
    public static void reflectClass(String name)
    {
        ...
        if (classes.containsKey(name) && c.isUnreflected())
        {
            ...
            {
                System.out.println(
                    "Message: Ended reflecting " + c.getName() + ".");
            }
        }
        else
        {
            System.err.println(
                "Fatal internal error: Class reflection requested but class is not present in classpool or already reflected.");
            System.exit(1);
        }
    }
    ...
    private static void reflect(Class c)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    System.err.println(
                        "Message: Expand name " + name_to_reflect + ":");
                }
                ...
                if ((path != null) && !path.hasUnknownExtension())
                {
                    ...
                    if (classes.containsKey(name_to_reflect) && ref_component)
                    {
                        ...
                        {
                            System.out.println(
                                "Message: Reflecting class "
                                    + name_to_reflect
                                    + " ...");
                        }

                        Class component = (Class)classes.get(name_to_reflect);
                ...
                else
                {
                    ...
                    {
                        System.out.println(
                            "Message: Reflecting [via java.lang.reflect] class "
                                + c.getName()
                                + " ...");
                    }

                    java.lang.Class cr =
                        NameAnalysis.classForName(name_to_reflect);
        ...
        {
            System.err.println(
                "Fatal Error: ParseException occured while parsing class "
                    + c
                    + ":\n"
                    + parse);
            System.exit(1);
        ...
        {
            System.err.println(
                "Fatal Error: ClassNotFoundException occured while trying to reflect class "
                    + c
                    + " via java.lang.relfect:\n"
                    + cnf);
            System.exit(1);
        }
    }
     ...
     */
    public static jass.reflect.Method getMethod(String classname, int number)
    {
     ...
     * @exception ArrayIndexOutOfBoundsException if number is out of range.
     */
    public static jass.reflect.Constructor getConstructor(
        String classname,
        int number)
    {
        jass.reflect.Class c = getClass(classname);
