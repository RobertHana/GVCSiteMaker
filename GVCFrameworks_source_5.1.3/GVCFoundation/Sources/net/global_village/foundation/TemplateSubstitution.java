...
public class TemplateSubstitution extends Object
{
    ...
    public static String substituteValuesInStringFromDictionary(String template, NSKeyValueCodingAdditions object)
    {
        ...
        try
        {
            return substituteValuesInStringFromDictionary(template, object, TemplateSubstitution.tokenStartElement, TemplateSubstitution.tokenEndElement);
        }
        catch (RuntimeException e)
        {
            throw new NSForwardException("Failed to substitute values [" + object + "] in template [" + template + "]", e);
        }
