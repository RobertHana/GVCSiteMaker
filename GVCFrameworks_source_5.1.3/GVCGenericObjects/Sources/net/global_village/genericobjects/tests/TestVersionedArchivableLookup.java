 ...
 *
 */  
public class TestVersionedArchivableLookup extends TestArchivableLookup
{
    ...
    // may not actually be used in unit tests, but a subclass in a real app would probably want these
    ...
    static public NSArray objectsWithQualifier(EOQualifier aQualifier, EOEditingContext editingContext)
    {
        ...
        return EOEditingContextAdditions.objectsWithQualifier(editingContext, "TestVersionedArchivableLookup", aQualifier);
    ...
    static public NSArray activeObjectsWithQualifier(EOQualifier aQualifier, EOEditingContext editingContext)
    {
        ...
        return VersionableArchivableObject.activeObjectsWithQualifier( editingContext, "TestVersionedArchivableLookup", aQualifier );
     ...
     * @param aQualifier the qualifier to use for the fetch
     * @param editingContext the <code>EOEditingContext</code> to fetch from
     * @return NSArray all active objects from this entity, qualified by aQualifier, sorted by NameComparator
     */
    static public NSArray orderedActiveObjectsWithQualifier(EOQualifier aQualifier, EOEditingContext editingContext)
    {
        /** require [editingContext_not_null] editingContext != null;  **/
        
        return VersionableArchivableObject.orderedActiveObjectsWithQualifier(editingContext, "TestVersionedArchivableLookup", aQualifier, VersionableArchivableLookup.NameComparator );
    ...
    /**
     *  Fetches all active objects sorted by NameComparator
     *
     * @param editingContext the <code>EOEditingContext</code> to fetch from
     * @return NSArray of the desired objects
     */
    static public NSArray orderedActiveObjects(EOEditingContext editingContext)
    {
        ...
        return VersionableArchivableObject.orderedActiveObjects(editingContext, "TestVersionedArchivableLookup", VersionableArchivableLookup.NameComparator);
    ...
    static public NSArray orderedObjects(EOEditingContext editingContext)
    {
        ...
        return VersionableArchivableObject.orderedObjects(editingContext, "TestVersionedArchivableLookup", VersionableArchivableLookup.NameComparator );
