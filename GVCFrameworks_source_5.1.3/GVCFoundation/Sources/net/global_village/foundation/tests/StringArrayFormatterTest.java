...
/**
 * Tests for net.global_village.foundation.StringArrayFormatter
 *
 * @author Copyright (c) 2001-2005  Global Village Consulting, Inc.  All rights reserved.
 * This software is published under the terms of the Educational Community License (ECL) version 1.0,
 * a copy of which has been included with this distribution in the LICENSE.TXT file.
 */
public class StringArrayFormatterTest extends TestCase
{
     ...
     * @param name of test
     */
    public StringArrayFormatterTest(String name)
    {
        super(name);
    }
    ...
    {
        Format formatter = new StringArrayFormatter(",", NullFormatter.Formatter);
        ...
        formatter = new StringArrayFormatter(",", IntegerFormatter.Formatter);
