...
/**
 * A Section Type for Sections that are temporary place holders for sections installed from a package.
 */
public class PackageSectionType extends _PackageSectionType
{
    /**
     * Returns the singleton instance of PackageSectionType in the passed EOEditingContext
     */
    public static PackageSectionType getInstance(EOEditingContext ec)
    {
        /** require [ec_not_null] ec != null; **/
        
        return (PackageSectionType) getInstance(ec, "PackageSectionType");
    ...
    /**
     * Factory method to create new instances of PackageSectionType.  Use this rather than calling the constructor
     * directly so that customized versions in GVCSMCustom will be used if present.
     *
     * @return a new instance of PackageSectionType or a subclass.
     */
    public static PackageSectionType newPackageSectionType()
    {
        return (PackageSectionType) SMEOUtils.newInstanceOf("PackageSectionType");
