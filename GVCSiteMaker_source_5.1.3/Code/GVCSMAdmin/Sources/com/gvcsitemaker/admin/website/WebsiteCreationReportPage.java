...
public class WebsiteCreationReportPage extends WOComponent implements SMSecurePage
{

    protected NSArray _websiteArray, _validWebsiteArray, _invalidWebsiteArray;


    public WebsiteCreationReportPage(WOContext aContext)
    {
        super(aContext);
    }
    ...
    public CreateWebsitePage returnToWebsiteCreation() {
